...
date_default_timezone_set('Europe/Spain');// change according timezone
...
<?php include('include/footer.php');?>
	...
	<script>
		$(document).ready(function() {
			$('.datatable-1').dataTable(); //La API de DataTables puede operar en varias tablas a la vez: las tablas en el "contexto". Como ejemplo rápido 
