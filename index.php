...
<html lang="es">
	<head>
	    ...
	    <title>Excesion - Pagina principal</title>
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Envio gratis</h4>
						</div>
					</div>
					<h6 class="text">Envio gratis en pedidos mayores a €.50</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Oferta Especial</h4>
						</div>
					</div>
					<h6 class="text">Todos los productos 10% de dscto </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Productos Destacados</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Servicios</a></li>
					<li><a href="#furniture" data-toggle="tab">KitDigital</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
// $ret=mysqli_query($con,"select * from products where category=1 and subCategory=14");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">KitDigital</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
